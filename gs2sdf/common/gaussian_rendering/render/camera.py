...
this is the standard Gaussian-Splatting-family camera convention.
...
This is a limitation of the upstream CUDA rasterizer itself.

Vendored from gs_sensors/gs_sensor_core/render/camera.py.
"""
...
from gs2sdf.common.gaussian_rendering.rotations import quat_to_rotmat
